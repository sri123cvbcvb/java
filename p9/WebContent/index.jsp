...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="asset1/css/owl.theme.css" type="text/css" media="all">
    <link rel="stylesheet" href="asset1/css/owl.carousel.css" type="text/css" media="screen" property="" />
    <link href="asset1/css/prettyPhoto.css" rel="stylesheet" type="text/css" />
    <link href="asset1/css/fontawesome-all.css" rel="stylesheet">
    <link href="//fonts.googleapis.com/css?family=Josefin+Sans:100,100i,300,300i,400,400i,600,600i,700,700i" rel="stylesheet">
    <link href="//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800" rel="stylesheet">
    <script src="asset1/js/val1.js"></script>
</head>
...
<body>
            ...
            <div class="header-top">
                <header class="mainheader">
                    <nav class="navbar second navbar-expand-lg navbar-light bg-light pagescrollfix">
                        <a class="navbar-brand pagescrolldisplay" href="index.html"><i class="fab fa-magento"></i></a>
                        <div class="collapse navbar-collapse navbar-toggle" id="navbarNavAltMarkup1">
                           <!--  <div class="navbar-nav secondfix mx-auto">
                                <a class="nav-item nav-link sec scroll" href="#about">Introduction</a>
                                <a class="nav-item nav-link sec scroll" href="#feature">Features</a>
                                <a class="nav-item nav-link sec scroll" href="#services">What we do</a>
                                <a class="nav-item nav-link sec scroll" href="#team">Experts</a>
                                <a class="nav-item nav-link sec scroll" href="#plan">Plans</a>
                                <a class="nav-item nav-link sec scroll" href="#clients">Testimonials</a>
                            </div> -->
                            <a class="nav-link request text-uppercase scrolldemo ml-auto pagescrolldisplay" href="#" data-toggle="modal" data-target="#exampleModalCenter"> Login</a>
                        </div>
                    </nav>
                    <nav class="navbar navbar-expand-lg navbar-light bg-light RWDpagescrollfix">
                        <h1><a class="navbar-brand" href="index.html"><i class="fab fa-magento"></i> Smog Free Tower</a></h1>
                        ...
                        <div class="collapse navbar-collapse navbar-toggle " id="navbarNavAltMarkup">
                            <ul class="navbar-nav mx-auto">
                             <!--    <li class="nav-item dropdown">
                                ...
                                <li><a class="nav-link text-uppercase" data-toggle="modal" data-target="#exampleModalCenter" onclick="pass('cli')" href="#">Client</a></li>
                                <li><a class="nav-link text-uppercase" data-toggle="modal" data-target="#exampleModalCenter" onclick="pass('ad')" href="#">Admin</a></li>
                                <li> <a class="nav-link text-uppercase" data-toggle="modal" data-target="#exampleModalCenter" onclick="pass('air')" href="#">Airsense</a></li>
                                <li><a class="nav-link text-uppercase" data-toggle="modal" data-target="#exampleModalCenter" onclick="pass('pure')" href="#">Purelon</a></li>
                                <li> <a class="nav-link text-uppercase" data-toggle="modal" data-target="#exampleModalCenter" onclick="pass('tower')" href="#">Towercraft</a></li>
                            </ul>
                            <!-- <div class="top-info text-left">
                                <ul>
                                    <li><i class="fas fa-phone-volume"></i> 12345678099</li>
                ...
                <div class="banner-content text-center text-white">
                    <h3>We Manage Your Business</h3>
                    <h4 class="text-uppercase">Strategy / Branding / Design / Interactive</h4>
                    <div class="banner-high-lights row">
                        <div class="bg-gd-info col-md-4">
                            <div class="bg-gd">
                                <i class="fab fa-react mb-2"></i>
                                <h5 class="my-2">Stunning design</h5>
                                Lorem ipsum dolor sit amet consectetur elit
                            </div>
                        </div>
                        <div class="bg-gd-info col-md-4">
                            <div class="bg-gd active">
                    ...
                    <div class="rotate">
                        <a href="#about" class="scroll text-uppercase">
            ...
            <div class="inner-sec-w3ls py-lg-5 py-3">
                <div class="row">
                    <div class="col-lg-6 about-img">
                        <img class="img-fluid" src="asset1/images/ab.jpg" alt="">
                    </div>
                    <div class="col-lg-6 about-right mt-lg-4">
                        <h4 class="sub-tittle">Who We Are</h4>
                        <h3 class="tittle text-uppercase">Doing the right thing at the right time.</h3>
                        ...
                        <ul class="author d-flex">
                            <li><img class="img-fluid" src="asset1/images/author.jpg" alt=""></li>
        ...
        <div class="container">
            <div class="inner-sec-w3ls py-lg-5 py-3">
                ...
                <div class="row mt-lg-5 mt-md-4 mt-4">
                    <div class="col-lg-4 about-in-w3ls text-center">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 about-in-w3ls mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 about-in-w3ls middle-grid-info active text-center">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title text-uppercase my-3">Best Business Solution</h5>
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 about-in-w3ls middle-grid-info text-center">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title text-uppercase my-3">Best Expert Consultancy</h5>
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing.
                                </p>
                            </div>
                        </div>
    ...
    <section class="gallery py-md-5 py-3">
        <div class="gallery-inner pb-md-5 pb-3">
            <h3 class="tittle text-center mb-md-5 mb-4">Latest Projects</h3>
                ...
                <li class="portfolio-item2" data-id="id-0" data-type="cat-item-3">
                    <span class="image-block img-hover">
                        <a class="image-zoom" href="images/g1.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g1.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-1" data-type="cat-item-2">
                    <span class="image-block">
                       <a class="image-zoom" href="images/g2.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g2.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-2" data-type="cat-item-1">
                    <span class="image-block">
                        <a class="image-zoom" href="images/g3.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g3.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-4" data-type="cat-item-3">
                    <span class="image-block">
                       <a class="image-zoom" href="images/g4.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g4.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-5" data-type="cat-item-2">
                    <span class="image-block">
                       <a class="image-zoom" href="images/g5.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g5.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-7" data-type="cat-item-1">
                    <span class="image-block">
                       <a class="image-zoom" href="images/g6.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g6.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-7" data-type="cat-item-1">
                    <span class="image-block">
                       <a class="image-zoom" href="images/g7.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g7.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
                <li class="portfolio-item2" data-id="id-7" data-type="cat-item-1">
                    <span class="image-block">
                        <a class="image-zoom" href="images/g8.jpg" data-gal="prettyPhoto[gallery]">
                            <img src="asset1/images/g8.jpg" class="img-fluid " alt="">
                        </a>
                    </span>
                </li>
            </ul>
    ...
    <section class="tean-sec bg-light py-md-5 py-3" id="team">
        <div class="container">
            <div class="inner-sec-w3ls py-md-5 py-3">
                <h4 class="sub-tittle text-uppercase text-center">Meet us</h4>
                <h3 class="tittle text-center mb-md-5 mb-4">Amezing Team</h3>
                <div class="row">
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="asset1/images/team1.jpg" class="img-fluid" alt="img">
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="asset1/images/team2.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="asset1/images/team3.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                                <ul class="social-icons justify-conten-center">
                                    <li class="mr-1"><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li class="mx-1"><a href="#"><span class="fab fa-twitter"></span></a></li>
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="asset1/images/team4.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                                <ul class="social-icons justify-conten-center">
                                    <li class="mr-1"><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li class="mx-1"><a href="#"><span class="fab fa-twitter"></span></a></li>
                ...
                <div class="row mt-lg-5 mt-3">
                    ...
                    <div class="col-lg-6 progress-info-content">
                        ...
                        <div class="progress-one my-lg-4">
                            <h4 class="progress-tittle">Web Services</h4>
                            <div class="progress">
    ...
    <!-- //team -->
    <!--/pricing -->
    <section class="pricing py-md-5 py-3" id="plan">
        <div class="container">
            <div class="inner-sec-w3ls py-md-5 py-3">
                <h4 class="sub-tittle text-uppercase text-center">Choose your Plan</h4>
                <h3 class="tittle text-center mb-md-5 mb-4">Pricing Plans</h3>
    ...
    <section class="bottom-last">
        <div class="bottom-bg py-5 bs-slider-overlay text-left">
            <h3 class="tittle">Ability & Motivated</h3>
    ...
    <!-- //bottom-last -->
    <!--/Blog-Posts-->
    <section class="banner-bottom-wthree bg-light py-md-5 py-4">
        <div class="container">
            <div class="inner-sec-w3ls py-md-5 py-4">
                ...
                <div class="row blog-sec">
                    <div class="col-lg-4 about-in-w3ls blog-grid-info text-left">
                        <div class="card img">
                            <div class="card-body img">
                                <img src="asset1/images/g7.jpg" alt="" class="img-fluid">
                                <div class="blog-des">
                    ...
                    <div class="col-lg-4 about-in-w3ls blog-grid-info text-left">
                        <div class="card img">
                            <div class="card-body img">
                                <img src="asset1/images/g1.jpg" alt="" class="img-fluid">
                                <div class="blog-des">
                    ...
                    <div class="col-lg-4 about-in-w3ls blog-grid-info text-left">
                        <div class="card img">
                            <div class="card-body img">
                                <img src="asset1/images/g4.jpg" alt="" class="img-fluid">
                                <div class="blog-des">
                ...
                <div class="owl-carousel owl-theme">
                        ...
                        <div class="feedback-info text-left">
                            ...
                            <div class="feedback-grids">
                                <div class="feedback-img">
                                    <img src="asset1/images/t1.jpg" class="img-fluid rounded-circle" alt="" />
                                </div>
                    ...
                    <div class="item">
                        <div class="feedback-info text-left">
                            ...
                            <div class="feedback-grids">
                                <div class="feedback-img">
                                    <img src="asset1/images/t3.jpg" class="img-fluid rounded-circle" alt="" />
                                </div>
                                <div class="feedback-img-info">
                                    <h5>Steven Wilson</h5>
                                    <p>United States
                    ...
                    <div class="item">
                        <div class="feedback-info text-left">
                            ...
                            <div class="feedback-grids">
                                <div class="feedback-img">
                                    <img src="asset1/images/t2.jpg" class="img-fluid rounded-circle" alt="" />
                                </div>
                                <div class="feedback-img-info">
                                    <h5>Peter guptill</h5>
            ...
            <div class="inner-sec-w3ls py-md-5 py-3">
                <div class="row mb-md-4 mb-3">
                    ...
                    <div class="col-md-6 n-right tex-left">
                        <h3 class="tittle foot mb-md-5 mb-4 text-white">Subscribe our Newsletter</h3>
                        ...
                        <div class="copyright mt-md-5 mt-3">
                            <h2><a class="navbar-brand" href="index.html">
                                        Startled</a></h2>
                            <p class="copy-right-w3ls mt-3">© 2018 Startled. All Rights Reserved | Design by
                                <a href="http://w3layouts.com/"> W3layouts </a>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 social-info text-right">
                        <h3 class="tittle foot mb-md-3 mb-4 text-white">Join us in the following social networks</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore.</p>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="Log" method="post">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="exampleInputEmail1" name="lemail" aria-describedby="emailHelp" placeholder="" required="">
                                <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                            </div>
                             <input id="role2" type="hidden" name="role" value="" />
                            <div class="form-group">
                                <label class="mb-2">Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1" name="lpass" placeholder="" required="">
                            </div>
                            ...
                            <p id="rn" class="text-center pb-4">
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="Reg" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="uname" id="validationDefault01" placeholder="" required="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" id="validationDefault02" placeholder="" required="">
                            </div>
                            <input id="role1" type="hidden" name="role" value=""   />
                            <div class="form-group">
                                <label class="mb-2">Password</label>
                                <input type="password" class="form-control" name="pass" id="password1" placeholder="" required="">
                            </div>
                            <div class="form-group">
                                <label>Confirm Password</label>
                                <input type="password" class="form-control" name="cpass" id="password2" placeholder="" required="">
                            </div>
    ...
    <!--//model-form-->
    <!-- js -->
    <script src="asset1/js/jquery-2.2.3.min.js"></script>
    <script>
    ...
    <!-- stats -->
    <script src="asset1/js/jquery.waypoints.min.js"></script>
    <script src="asset1/js/jquery.countup.js"></script>
    <script>
        $('.counter').countUp();
    ...
    <!-- carousel -->
    <script src="asset1/js/owl.carousel.js"></script>
    <script>
    ...
    <script src="asset1/js/move-top.js"></script>
    <script src="asset1/js/easing.js"></script>
    <script>
    ...
    <!--// end-smoth-scrolling -->
    <script src="asset1/js/jquery-1.7.2.js"></script>
    <script src="asset1/js/jquery.quicksand.js"></script>
    <script src="asset1/js/pretty-script.js"></script>
    <script src="asset1/js/jquery.prettyPhoto.js"></script>
    <!-- //jQuery-Photo-filter-lightbox-Gallery-plugin -->
    <!-- /js -->
