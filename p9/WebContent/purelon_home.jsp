...
<html lang="en">
  <head>
    ...
    <title>Dream Business a Business Category Bootstrap Responsive Website Template | Home :: W3layouts</title>
  <!-- web fonts -->
  ...
  <!-- //web fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="asset5/css/style-starter.css">
  </head>
  <body>
...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
    <div class="container">
      <a class="navbar-brand" href="index.html"><span>P</span>urelon</a>
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="purelon_view_cl_dt.jsp">Client Details</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="purelon_view_airsense_report.jsp">Airsense Report</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="contact.html">Analyzed Report</a>
          </li>
...
<section class="w3l-main-slider" id="home">
  ...
  <script src="asset5/js/owl.carousel.js"></script>
  <!-- script for -->
  <script>
		...
		<div class="container py-md-3">
			...
			<div class="calltoaction-20-content row">
				...
				<div class="column ccont-left col-lg-6 mt-lg-0 mt-5">
					<img src="asset5/images/g1.jpg" class="img-responsive" alt="">
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mt-md-4 mt-4">
            <div class="grids5-info">
              <a href="#" class="d-block zoom"><img src="asset5/images/g2.jpg" alt="" class="img-fluid news-image"></a>
              <div class="blog-info">
          ...
          <div class="col-lg-4 col-md-6 mt-md-4 mt-5">
            <div class="grids5-info">
              <a href="#" class="d-block zoom"><img src="asset5/images/g4.jpg" alt="" class="img-fluid news-image"></a>
              <div class="blog-info">
          ...
          <div class="col-lg-4 offset-md-3 offset-lg-0 col-md-6 mt-md-4 mt-5">
            <div class="grids5-info">
              <a href="#" class="d-block zoom"><img src="asset5/images/g6.jpg" alt="" class="img-fluid news-image"></a>
              <div class="blog-info">
...
<script src="asset5/js/jquery-3.3.1.min.js"></script>
<!-- //footer-28 block -->
</section>
<script>
  $(function () {
...
<!-- Template JavaScript -->
<script src="asset5/js/all.js"></script>
<!-- Smooth scrolling -->
<!-- <script src="asset5/js/smoothscroll.js"></script> -->
<script src="asset5/js/owl.carousel.js"></script>
